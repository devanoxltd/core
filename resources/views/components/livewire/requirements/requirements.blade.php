        ...
        <table class="w-full table-auto text-left text-sm text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($requirements as $requirement)
                    <tr wire:key="requirement-{{ md5($requirement['name']) }}" class="snap-end border-b bg-white dark:border-gray-600 dark:bg-gray-800">
                        ...
                        >
                            ...
                            @else
                                <x-ui.form.button
                                    aria-label="{{ __('core::install.steps.requirements.table.refresh_requirements', ['name' => $requirement['name']]) }}"
                                    class="mr-1"
                                    color="gray"
                                    size="xs"
